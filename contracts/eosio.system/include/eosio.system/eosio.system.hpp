...
namespace eosiosystem {
   ...
   struct [[eosio::table("global"), eosio::contract("eosio.system")]] eosio_global_state : eosio::blockchain_parameters {
      ...
      ALALIB_SERIALIZE_DERIVED( eosio_global_state, eosio::blockchain_parameters,
                                (max_ram_size)(total_ram_bytes_reserved)(total_ram_stake)
                                (last_producer_schedule_update)(last_pervote_bucket_fill)(perwitness_bucket)
   ...
   struct [[eosio::table("global2"), eosio::contract("eosio.system")]] eosio_global_state2 {
      ...
      ALALIB_SERIALIZE( eosio_global_state2, (new_ram_per_block)(last_ram_increase)(last_block_num)
   ...
   struct [[eosio::table("global3"), eosio::contract("eosio.system")]] eosio_global_state3 {
      ...
      ALALIB_SERIALIZE( eosio_global_state3, (last_vpay_state_update)(total_vpay_share_change_rate) )
   };
   ...
   struct [[eosio::table, eosio::contract("eosio.system")]] voter_info {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      ALALIB_SERIALIZE( voter_info, (owner)(proxy)(producers)(staked)(last_vote_weight)(proxied_vote_weight)(is_proxy)(flags1)(reserved2)(reserved3) )
   };
   ...
   class [[eosio::contract("eosio.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name wpay_account{"eosio.wpay"_n};
      ...
      private:
         ...
         void check_voter( const name& owner, const char* error_msg = "Block Producers cannot vote." )const;
