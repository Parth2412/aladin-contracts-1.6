...
namespace eosiosystem {
   ...
   struct [[eosio::table("global"), eosio::contract("eosio.system")]] eosio_global_state : eosio::blockchain_parameters {
      ...
      microseconds         vote_claim_period = eosio::days( 30 );
   ...
   struct [[eosio::table("global4"), eosio::contract("eosio.system")]] eosio_global_state4 {
      ...
      EOSLIB_SERIALIZE( eosio_global_state4, (last_wpay_state_update)(total_wpay_share_change_rate)(total_producer_witnesspay_share) )
   };
   ...
   struct [[eosio::table, eosio::contract("eosio.system")]] producer_info3 {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      EOSLIB_SERIALIZE( producer_info3, (owner)(witnesspay_share)(last_witnesspay_share_update) )
   };
   ...
   struct [[eosio::table, eosio::contract("eosio.system")]] voter_info {
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      EOSLIB_SERIALIZE( voter_info, (owner)(proxy)
   ...
   struct [[eosio::table, eosio::contract("eosio.system")]] oracle_info {
      name       producer;
      name       oracle_account;
   ...
   typedef eosio::multi_index< "oracles"_n, oracle_info,
   ...
   struct [[eosio::table, eosio::contract("eosio.system")]] request_info {
      uint64_t         id;
      time_point       time;
   ...
   typedef eosio::multi_index< "requests"_n, request_info > request_info_table;


   struct [[eosio::table("oraclereward"), eosio::contract("eosio.system")]] oracle_reward_info {
      uint32_t total_successful_requests = 0;
   };
   typedef eosio::singleton< "oraclereward"_n, oracle_reward_info > oracle_reward_info_singleton;
   ...
   class [[eosio::contract("eosio.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name bpay_account{"eosio.bpay"_n};     // stores tokens for Block producers rewards
         static constexpr eosio::name dpay_account{"eosio.dpay"_n};     // stores tokens for DApps developers rewards
         static constexpr eosio::name wpay_account{"eosio.wpay"_n};     // stores tokens for Witnesses rewards
         static constexpr eosio::name vpay_account{"eosio.vpay"_n};     // stores tokens for Voters rewards
         static constexpr eosio::name oracle_account{"eosio.oracle"_n}; // stores tokens for Oracle rewards
         static constexpr eosio::name network_account{"eosio.net"_n};
         static constexpr eosio::name infrastructure_account{"eosio.infra"_n};
         static constexpr eosio::name community_account{"eosio.comm"_n};
         static constexpr eosio::name marketing_account{"eosio.market"_n};
         static constexpr eosio::name founding_account{"eosio.found"_n};
         ...
         [[eosio::action]]
         void addrequest( uint64_t request_id, const eosio::name& caller, const std::vector<api>& apis, uint16_t response_type, uint16_t aggregation_type, uint16_t prefered_api, std::string string_to_count );

         [[eosio::action]]
         void reply( const eosio::name& caller, uint64_t request_id, const std::vector<char>& response );

         [[eosio::action]]
         void setoracle( const eosio::name& producer, const eosio::name& oracle );
         ...
         using claimdapprwd_action = eosio::action_wrapper<"claimdapprwd"_n, &system_contract::claimdapprwd>;
         using claimvoterwd_action = eosio::action_wrapper<"claimvoterwd"_n, &system_contract::claimvoterwd>;
         using setvclaimprd_action = eosio::action_wrapper<"setvclaimprd"_n, &system_contract::setvclaimprd>;
